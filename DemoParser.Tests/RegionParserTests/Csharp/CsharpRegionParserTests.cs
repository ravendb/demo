...
{
    public class CsharpRegionParserTests
    {
        ...
        private static readonly string DefaultFilePath = Path.Join("RegionParserTests", "Csharp", "Input.cs");
        private static readonly string MultipleDemoRegionsPath = Path.Join("RegionParserTests", "Csharp", "MultipleDemoRegionsInput.cs");
