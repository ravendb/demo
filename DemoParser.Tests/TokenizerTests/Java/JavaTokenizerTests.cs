...
namespace DemoParser.Tests.TokenizerTests.Java
{
    public class JavaTokenizerTests : TokenizerTests
    {
        ...
        private static readonly string DefaultFilePath = Path.Join("TokenizerTests", "Java", "Input.java");
